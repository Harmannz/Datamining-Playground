...
public class MainGriewanks {
    ...
    public static void main(String[] args) {
        ...
        swarm.setProblem(new GriewanksProblem());
//         swarm.setTopology(new StarTopology());
//        swarm.setTopology(new RingTopology());
        ...
        try {
            ...
            File myFilePath = new File("BestfitnessRuns_Griewanks.txt");
            File myFilePath2 = new File("Plot_Griewanks.txt");
