...
public class GPClassification {
    private static final String FILENAME = "traini";
    private static final String TRAINING_FILENAME = "training.csv";
    private static final String TEST_FILENAME = "test.csv";
    private static final int MAXIMUM_EVOLUTIONS = 800;
    private static final double TERMINATION_CRITERIA = 10;
